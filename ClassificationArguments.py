...
parser.add_argument('-C', '--config',default="/Users/mattzhang/Desktop/DLKit/CaloDNN/ClassificationScanConfig.py")

parser.add_argument('-L', '--LoadModel',default=False)
parser.add_argument('-Ls', '--LoadModels',default=False) # point to a txt file with the model names
